...
class indexView(View):
    def get(self, r):
        ...
        stream_data=stream.objects.all()
        level_data=level.objects.all()
        spl_data=specialization.objects.all()
        qlp_data=Qualifications.objects.all()

        country_data=Country.objects.all()
        state_data=State.objects.all()
        dist_data=Dist.objects.all()
        city=City.objects.all()
        Pin=Pincode.objects.all()

        Religion_data=Religion.objects.all()
        caste_data=Caste.objects.all()
        subcaste_data=Subcaste.objects.all()

        Languge_data=Languge.objects.all()
        ...
        context={
            ...
            'subcaste_data':subcaste_data,
            'Languge_data':Languge_data,
